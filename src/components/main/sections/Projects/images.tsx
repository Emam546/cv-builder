...
export const UploadButton = React.forwardRef<HTMLInputElement, Props>(
  ({ defaultValue, label, setValue, name, control, aspect, imageId }, ref) => {
    ...
    return (
      <>
        <div className="pt-5 select-none group">
          {!orgImg && !loading && (
            <div
              onClick={() => {
                setEdit(true);
            ...
            >
              ...
              >
                <div className="text-center">
                  <FontAwesomeIcon
                    icon={faImage}
                    className="text-6xl text-neutral-50 group-hover:text-blue-50"
                  />
          ...
          {orgImg && !loading && (
            <div className="cursor-pointer">
              ...
              >
                <div className="relative z-10 hidden text-center group-hover:block">
                  <div className="font-medium">
                    <button
                      type="button"
                      className="block cursor-pointer text-blue-40 hover:text-blue-50"
                    ...
                    <button
                      type="button"
                      className="block mt-1 cursor-pointer text-neutral-20 hover:text-red-40"
                      onClick={(e) => {
                        stateAccept.accept(() => {
      ...
      >
        <div className="mb-2">
          ...
          <UploadButton
            ...
            control={control}
            defaultValue={
              loadash.get(control._defaultValues, `${Name}.${i}.image`) as any
            }
          />
        </div>
      </Elem>
